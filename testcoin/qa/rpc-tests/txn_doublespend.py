...
from test_framework import ChncoinTestFramework
...
class TxnMallTest(ChncoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 CHN:
        ...
        # First: use raw transaction API to send 1210 CHN to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50CHN for another
        ...
        # Node0's total balance should be starting balance, plus 100CHN for 
