...
###   This script attempts to download the signature file SHA256SUMS.asc from chncoin.org
...
WORKINGDIR="/tmp/chncoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://chncoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://chncoin.org/bin/"
VERSIONPREFIX="chncoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'chncoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[chncoin-]<version>-[rc[0-9]] (example: chncoin-0.9.2-rc1)"
   echo "wget output:"
