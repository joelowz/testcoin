The following is a list of assets used in the chncoin source and their proper attribution.
...
* License: MIT
* Site: [https://chncointalk.org/index.php?topic=15276.0](https://chncointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original chncoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/chncoin.icns, src/qt/res/src/chncoin.svg,
	src/qt/res/src/chncoin.ico, src/qt/res/src/chncoin.png,
	src/qt/res/src/chncoin_testnet.png, docs/chncoin_logo_doxygen.png,
