Chncoin Core version 0.9.4 is now available from:

  https://chncoin.org/bin/0.9.4/
...
this update is incompatible with the Chncoin system and could lead to consensus
forks.

Chncoin Core released binaries from https://chncoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~chncoin/+archive/ubuntu/chncoin
- A third-party or self-compiled Chncoin Core

upgrade to Chncoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
