Chncoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/chncoin/files/Chncoin/chncoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Chncoin
...
New/changed settings (command-line or chncoin.conf file)
--------------------------------------------------------
