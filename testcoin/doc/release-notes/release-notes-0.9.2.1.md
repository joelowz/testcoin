Chncoin Core version 0.9.2.1 is now available from:

  https://chncoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 CHN to 0.01 CHN
...
- Fix "Start chncoin on system login"
