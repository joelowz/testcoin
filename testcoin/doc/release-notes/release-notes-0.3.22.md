Download URL: https://sourceforge.net/projects/chncoin/files/Chncoin/chncoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 CHN fee schedule (users still pay 0.01 CHN per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #chncoin00 - #chncoin99
