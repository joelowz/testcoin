Chncoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/chncoin/files/Chncoin/chncoin-0.5.4/
...
http://gitorious.org/chncoin/chncoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Chncoin-Qt notifications under Growl 1.3.
Increase required age of Chncoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxChncoin properly when installing Chncoin-Qt over it. (Windows)
