...
#ifndef CHNCOIN_RPCPROTOCOL_H
#define CHNCOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! Chncoin is not connected
