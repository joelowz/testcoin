...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CChncoinAddress demoAddress = CChncoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CChncoinAddress setaccountDemoAddress = CChncoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CChncoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CChncoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
