...
#ifndef CHNCOIN_QT_CHNCOINUNITS_H
#define CHNCOIN_QT_CHNCOINUNITS_H
...
/** Chncoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ChncoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ChncoinUnits(QObject *parent);

    /** Chncoin units.
      @note Source: https://en.chncoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CHN,
...
typedef ChncoinUnits::Unit ChncoinUnit;

#endif // CHNCOIN_QT_CHNCOINUNITS_H
