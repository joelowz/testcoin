...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/chncoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Chncoin Core"),
     ...
     * override -datadir in the chncoin.conf file in the default data directory
     * (to be consistent with chncoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
