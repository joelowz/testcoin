...
unlocked to sign the Chncoin-Qt.app bundle.
...
allowing somebody to distribute a Chncoin-Qt.app or chncoin-qt-setup.exe with a valid
...
that the chncoin-qt.exe file inside the installer had not been tampered with.
